...
class Dependencies : ListenerAdapter() {
    ...
    override fun onSlashCommandInteraction(event: SlashCommandInteractionEvent) {
        ...
        if (query.isNullOrBlank()) {
            event.reply("❌ Please provide the name of a package or library to search for.").setEphemeral(true).queue()
            return
        }
        ...
        val embed = EmbedBuilder()
            ...
            .setDescription("Results from Maven, NPM, and Yarn repositories.")
